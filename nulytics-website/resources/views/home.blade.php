                ...
                <div class="testimonial-wrap testimonial-style-2 sidemenu-wrapper-testimonial-slider-active cr-slider-dots-1">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>A restaurant management software that enables restaurant owners and employees to manage all of their business activities. 
                            It is a comprehensive platform with industry-standard feature sets and excellent user experience.</p>
                        </div>
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>An educational platform which delivers immersive scholarly experience and is intended for 
                            high school students and for corporate knowledge and training purposes.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>A software platform to assess the financial health of organizations that focuses on legal 
                            compliance encompassing core financial tools such as general ledger, 
                            accounts payable and receivable, purchase order, stock, inventory and billing.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Automating diverse services of a Diagnostic Center - 
                            for example, sample collection, report delivery, doctors’ commission, collection volume, etc.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>A Hospital Management System to increase efficiency, coordination, transparency 
                            between multiple departments. Ultimate goal is to promote better decision making and provide better patient care.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>We have developed a solution that will simplify your business by managing your store, medicine sales, inventory etc.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>An integrated and flexible system that is affordable for small to medium enterprises.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Front Desk Operations with a simple and modern user interface that 
                            simplifies visitor check-in system and streamlines front desk operations.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Our smart ERP system is simple to use. No need to deal with complex and hard-to-understand user experience. Analyze, monitor, 
                            increase data insight, automate the production line, identify opportunities and standardize processes with our ERP.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Automate your distribution business with our state-of-the-art 
                            Distribution Management System. Collect, organize, display, analyze real-time 
                            data and monitor your entire distribution network.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Our web-based School Management Software for your organization can be securely accessed online. 
                            It is now easy to automate day to day school administrative work like attendance, student info management, class routine, exam schedule and a 
                            lot more. School administrators can effortlessly look at information, reports, files & documents from multiple departments.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Our Complex Management System includes features like up-to-date Lease Holder, tenant information, 
                            multiple floors and multiple complexes add option, and utility bills configure option, 
                            basic accounts, Staff attendance and many more.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Our property management application focuses on revenue generation by automating
                             work processes (online room booking, availability and monitoring services) of guest houses, hotels and resorts.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Specialized Accounting & Inventory software for Petrol 
                            Pump Management with daily financial entries and streamlined operational record-keeping.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>Our comprehensive platform was created from the ground up to match the needs of health and beauty business owners nationwide. 
                            Features like appointment scheduling, sales, accounting, inventory and customized reports are part of the platform.</p>
                        </div>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial text-center"> 
                        ...
                        <div class="testimonial-content">
                            <p>It allows you to manage appointments and bookings. This is a perfect scheduling system for the Doctor’s Chamber.</p>
                        </div>
                        <div class="testimonial-author">
