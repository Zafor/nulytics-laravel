                    ...
                    <div class="container d-block d-lg-none">
                        <div class="mobile-menu clearfix">
                            <a class="mobile-logo" href="/home">
                                <img src="images/logo/nulytics-light.png" alt="mobile logo">
                            </a>
                        ...
                        <div class="footer-widgets widgets">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6 col-12">
                                    <!-- Single Widget -->
                                     ...
                                     <div class="single-widget widget-quick-contact">
                                        <h5 class="footer-widget-title">Bangladesh Contact</h5>
                                        <ul>
                                            <li>
                                                <span>Phone</span>
                                                <p>
                                ...
                                <div class="col-xl-3 col-md-6 col-12">
                                    <!-- Single Widget -->
                                    <div class="single-widget widget-quick-contact">
                                        <h5 class="footer-widget-title">US Contact</h5>
                                        <ul>
                                            <li>
                                                <span>Phone</span>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <ul class="footer-social">
                                    <li>
                                        <a href="https://www.facebook.com/nulytics/">Facebook</a>
                                    </li>
                                    <li>
